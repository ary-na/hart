          ...
          {isAuthenticated && userRole !== "admin" && (
            <div className="dropdown dropdown-end">
              ...
              >
                ...
                {cartTotals.count > 0 && (
                  <span className="absolute -right-0.5 -top-0.5 flex h-4 w-4 items-center justify-center rounded-full bg-accent text-[10px] font-bold text-accent-content leading-none">
                    {cartTotals.count}
                  </span>
                )}
              </button>
